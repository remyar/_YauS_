...
enum
{
	...
	YAUS_QUEUE_RS4852_RX_HANDLE,
	YAUS_QUEUE_RS4852_TX_HANDLE,
	YAUS_QUEUE_RS4853_RX_HANDLE,
	YAUS_QUEUE_RS4853_TX_HANDLE,
	YAUS_QUEUE_SPI1_RX_HANDLE,
	YAUS_QUEUE_SPI1_TX_HANDLE,
	YAUS_QUEUE_VSPI1_RX_HANDLE,
	YAUS_QUEUE_VSPI1_TX_HANDLE,
};
